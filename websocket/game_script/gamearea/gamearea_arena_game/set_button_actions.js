  ...
  socket.on("buttonAction", (actionType) => {
    switch (actionType) {
      ...
      case "buttonForwardSpeedAction":
        ...
        break;
      case "buttonBackwardSpeedAction":
